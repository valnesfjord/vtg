...
impl Keyboard {
    pub fn new(buttons: Vec<Vec<KeyboardButton>>, inline: bool, one_time: bool) -> Self {
        Self {
            inline,
            one_time,
            vk_buttons: VKKeyboard {
                ...
                buttons: buttons
                    ...
                    .map(|a| {
                        a.iter()
                            .map(|b| match b {
                                KeyboardButton::Text { label, color, data } => VKKeyboardButton {
                                ...
                                KeyboardButton::TGKeyboardButton { text, .. } => VKKeyboardButton {
                                    action: KeyboardButtonAction {
                                        r#type: "text".to_string(),
                                        label: Some(text.clone()),
                                        payload: None,
